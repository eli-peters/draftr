...
const sections: { title: string; rows: Row[] }[] = [
  ...
  {
    title: 'Ride Detail — Signup Action Bar',
    rows: [
      {
        area: 'Action Bar',
        file: 'rides/ride-signup-action-bar.tsx',
        ...
        mobile: 'fixed',
        desktop: 'sticky',
        notes: 'variant from state.ctaVariant · pill on mobile, rounded-2xl on desktop',
      ...
      },
      {
        ...
        mobile: 'fixed',
        desktop: 'sticky',
        notes: 'shown only in confirm-leave mode',
