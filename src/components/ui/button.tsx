  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-base font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-5",
  {
    variants: {
      variant: {
        ...
        gradient:
          "bg-gradient-to-r from-primary to-destructive text-primary-foreground shadow-md glow-primary-sm hover:shadow-lg hover:glow-primary press-scale",
        outline:
        ...
        info: "bg-info/10 text-info hover:bg-info/20 dark:bg-info/15 dark:hover:bg-info/25",
      ...
      size: {
        ...
        cta: "h-14 gap-2.5 px-8 text-lg font-semibold rounded-xl has-data-[icon=inline-start]:pl-6 [&_svg:not([class*='size-'])]:size-5",
        icon: "size-10",
        "icon-xs":
