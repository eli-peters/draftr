...
export function BottomNav({ items }: BottomNavProps) {
  ...
  return (
    <div className="fixed left-(--bar-inset-x) right-(--bar-inset-x) bottom-[max(var(--bar-inset-bottom),env(safe-area-inset-bottom,0px))] z-50 mx-auto max-w-lg md:hidden">
                ...
                >
                  {isActive && (
                    <motion.span
                      ...
                      className="absolute inset-x-0 inset-y-1 -z-10 rounded-full bg-action-primary-subtle-bg"
