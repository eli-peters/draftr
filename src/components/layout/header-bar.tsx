...
export function HeaderBar({
  ...
  return (
    <header className="material-regular sticky top-0 z-40 flex items-center justify-between border-b border-(--border-subtle) px-5 pt-[calc(env(safe-area-inset-top)+0.75rem)] pb-3 md:bg-surface-default md:[backdrop-filter:none] md:px-8">
